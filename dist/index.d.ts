...
declare function createAppEventHandler(stack: Stack, options: AppOptions): EventHandler<void | http.ServerResponse<http.IncomingMessage>>;
 ...
 * ```
 */
declare function readBody<T = any>(event: H3Event, options?: {
    strict?: boolean;
